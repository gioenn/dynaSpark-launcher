...
class Config(object):
    ...
    GIT_XSPARK_REPO = "https://github.com/DavideB/xSpark.git"                   # new
    GIT_XSPARK_BRANCH = "symex_0.5"         # was "xSpark-1.0"
    GIT_XSPARK_DAGSYMB_REPO = "https://github.com/DavideB/xSpark-dagsymb.git"   # new
